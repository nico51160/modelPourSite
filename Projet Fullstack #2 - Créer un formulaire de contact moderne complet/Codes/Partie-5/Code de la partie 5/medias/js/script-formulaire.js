...
/****** Contrôler la qualité des infos entrées dans le formulaire */
    ...
    let FonctionReponse = (reponse)=> {
        ...
        if( (retour[1] == 'error') || (retour[3] == 'error') || (retour[5] == 'error') || (retour[7] == 'error') ) {
    ...
    /*** Fonction Data */
    let FonctionData = (nom, prenom, email, msg) => {
    ...
    bouton.addEventListener('click', function(e) {
        if( validerString(nom,'Nom') && validerString(prenom,'Prenom') && validerEmail() ) {
            ...
            FonctionData(nom.value, prenom.value, email.value, msg.value);
